---
title: Day-24-类加载器&反射&模块化 # 添加博文标题
...
2. 在myOne模块中创建以下包和以下类，并在类中添加方法
   ...
   ![01](day24-类加载器&反射&模块化/01.png)

   ![02](day24-类加载器&反射&模块化/02.png)

3. 在myTwo模块中创建以下包和以下类，并在类中创建对象并使用

   ![03](day24-类加载器&反射&模块化/03.png)

   ![04](day24-类加载器&反射&模块化/04.png)

4. 在myOne模块中src目录下，创建module-info.java，并写入以下内容

   ![05](day24-类加载器&反射&模块化/05.png)

5. 在myTwo模块中src目录下，创建module-info.java，并写入以下内容

   ![06](day24-类加载器&反射&模块化/06.png)

### 3.3模块服务的基本使用【应用】

1. 在myOne模块中新建一个包，提供一个接口和两个实现类

   ![07](day24-类加载器&反射&模块化/07.png)

   ![08](day24-类加载器&反射&模块化/08.png)

   ![09](day24-类加载器&反射&模块化/09.png)

2. 在myOne模块中修改module-info.java文件，添加以下内容

   ![10](day24-类加载器&反射&模块化/10.png)

3. 在myTwo模块中新建一个测试类

   ![11](day24-类加载器&反射&模块化/11.png)

   ![12](day24-类加载器&反射&模块化/12.png)

4. 在myTwo模块中修改module-info.java文件，添加以下内容

   ![13](day24-类加载器&反射&模块化/13.png)
