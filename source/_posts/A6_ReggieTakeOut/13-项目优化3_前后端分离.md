...
![image-20210831232554721](13-项目优化3_前后端分离/image-20210831232554721.png)
...
![image-20210901082121874](13-项目优化3_前后端分离/image-20210901082121874.png)
...
![image-20210901084945348](13-项目优化3_前后端分离/image-20210901084945348.png)

​            

![image-20210901085057990](13-项目优化3_前后端分离/image-20210901085057990.png)
...
![image-20210901110936381](13-项目优化3_前后端分离/image-20210901110936381.png)
...
![image-20210901115408908](13-项目优化3_前后端分离/image-20210901115408908.png)
...
![image-20210901123709298](13-项目优化3_前后端分离/image-20210901123709298.png)

 

![image-20210901124623325](13-项目优化3_前后端分离/image-20210901124623325.png)
...
![image-20210901125311166](13-项目优化3_前后端分离/image-20210901125311166.png)
...
![image-20210901125517274](13-项目优化3_前后端分离/image-20210901125517274.png)

 

接口基本信息录入之后，添加提交，就可以看到该接口的基本信息：

![image-20210901125617777](13-项目优化3_前后端分离/image-20210901125617777.png)

  

但是目前，接口中我们并未指定请求参数，响应数据等信息，我们可以进一步点击编辑，对该接口 详情进行编辑处理。

![image-20210901140052897](13-项目优化3_前后端分离/image-20210901140052897.png)
...
![image-20210901140924816](13-项目优化3_前后端分离/image-20210901140924816.png)
...
![image-20210901150153468](13-项目优化3_前后端分离/image-20210901150153468.png)

 

而在导出的html文件或md文件中，主要描述的就是接口的基本信息， 包括： 请求路径、请求方式、接口描述、请求参数、返回数据等信息。展示形式如下： 

<img src="13-项目优化3_前后端分离/image-20210901150401976.png" alt="image-20210901150401976" style="zoom: 80%;" />
...
<img src="13-项目优化3_前后端分离/image-20210901151127926.png" alt="image-20210901151127926" style="zoom:80%;" />

 

导入过程中出现的确认弹窗，选择"确认"。

<img src="13-项目优化3_前后端分离/image-20210901151508478.png" alt="image-20210901151508478" style="zoom:80%;" />

 

导入成功之后，我们就可以在Yapi平台查看到已导入的接口。

![image-20210901151721356](13-项目优化3_前后端分离/image-20210901151721356.png)
...
![image-20210901160434736](13-项目优化3_前后端分离/image-20210901160434736.png)
...
![image-20210901200739975](13-项目优化3_前后端分离/image-20210901200739975.png)
...
![image-20210901201229838](13-项目优化3_前后端分离/image-20210901201229838.png)
...
![image-20210901214706928](13-项目优化3_前后端分离/image-20210901214706928.png)
...
![image-20210901215244539](13-项目优化3_前后端分离/image-20210901215244539.png)
...
![image-20210901221213897](13-项目优化3_前后端分离/image-20210901221213897.png)
...
![image-20210901221425159](13-项目优化3_前后端分离/image-20210901221425159.png)
...
![image-20210901231943256](13-项目优化3_前后端分离/image-20210901231943256.png)

 

将整个dist目录上传至/usr/local/nginx/html目录下

![image-20210901231924028](13-项目优化3_前后端分离/image-20210901231924028.png)
...
![image-20210901232931577](13-项目优化3_前后端分离/image-20210901232931577.png)
...
![image-20210901233135468](13-项目优化3_前后端分离/image-20210901233135468.png)
...
![image-20210901234142706](13-项目优化3_前后端分离/image-20210901234142706.png)
...
![image-20210902002307537](13-项目优化3_前后端分离/image-20210902002307537.png)
...
![image-20210902002328883](13-项目优化3_前后端分离/image-20210902002328883.png)
...
![image-20210902002357900](13-项目优化3_前后端分离/image-20210902002357900.png)
...
![image-20210902004033417](13-项目优化3_前后端分离/image-20210902004033417.png)
...
![image-20210902004308106](13-项目优化3_前后端分离/image-20210902004308106.png)
...
![image-20210902005320980](13-项目优化3_前后端分离/image-20210902005320980.png)

 

执行完shell脚本之后，我们可以通过 ps -ef|grep java 指令，查看服务是否启动。

![image-20210902005450399](13-项目优化3_前后端分离/image-20210902005450399.png)
...
![image-20210902005640875](13-项目优化3_前后端分离/image-20210902005640875.png)
...
![image-20210902005957772](13-项目优化3_前后端分离/image-20210902005957772.png)
...
![image-20210902010223733](13-项目优化3_前后端分离/image-20210902010223733.png)
...
![image-20210902010440908](13-项目优化3_前后端分离/image-20210902010440908.png)
...
![image-20210902010704691](13-项目优化3_前后端分离/image-20210902010704691.png)
...
![image-20210902010952388](13-项目优化3_前后端分离/image-20210902010952388.png)
